...
class Error extends Component {
    constructor(props) {
        ...
        this.toggleDisappear = this.toggleDisappear.bind(this);
    }

    toggleDisappear() {
        this.ghost.current.classList.toggle('reveal');
    }
    ...
    render() {
        ...
        const title = statusCode === 404 ? 'Page introuvable - Ooperz' : 'Erreur interne - Ooperz';
                            ...
                            <Link href="/">
                                <a className="button-container">
                                    <button className="flex-center">
                                        <FontAwesomeIcon icon={faArrowRight} />
                                        <p className="flex-column">Page d'accueil</p>
                                    </button>
                                </a>
                            </Link>
                        </div>
